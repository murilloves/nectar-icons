...
class Icons extends React.Component {
  ...
  <symbol id="nectaricon-close-sign" viewBox="0 0 24 24"><defs><clipPath id="a"><rect width="24" height="24" fill="none"/></clipPath></defs><g clip-path="url(#a)"><path d="M0,0H24V24H0Z" fill="none"/><g transform="translate(11.959 1) rotate(45)"><rect width="4" height="16" rx="0" transform="translate(6)"/><rect width="4" height="16" rx="0" transform="translate(16 6) rotate(90)"/></g></g></symbol>
  ...
  <symbol id="nectaricon-new-checkbox" viewBox="0 0 24 24"><path d="M19 5v14H5V5h14m0-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z"></path><path d="M0 0h24v24H0z" fill="none"></path></symbol>
  <symbol id="nectaricon-new-checkbox-checked" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M19 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.11 0 2-.9 2-2V5c0-1.1-.89-2-2-2zm-9 14l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></symbol>
